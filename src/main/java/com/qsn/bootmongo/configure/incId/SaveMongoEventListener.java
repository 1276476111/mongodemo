...
public class SaveMongoEventListener extends AbstractMongoEventListener<Object> {
        ...
        if (Objects.nonNull(source)) {
            ...
            ReflectionUtils.doWithFields(source.getClass(), field -> {
                ...
                if (field.isAnnotationPresent(AutoInc.class) && field.get(source) instanceof Number) {
                    ...
                    //获取自增主键
                    Long incId = getIncId(collectionName);
                    //对ID进行替换
                    document.put("_id", incId);
                    field.set(source, incId);
                }
            });
        }
     ...
     * @return 自增的主键
     */
    private Long getIncId(String collectionName) {
        ...
        IncInfo andModify = mongoTemplate.findAndModify(query, update, options, IncInfo.class);
        Assert.notNull(andModify, "主键自增时返回参数异常");
        return andModify.getIncId();
    }
}